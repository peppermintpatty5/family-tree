...
\tikzset{
    block/.style = {
            draw, rectangle, text width=5.4em, align=center, minimum height=4.2em},
}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node [text width=12cm, anchor=north west] at (0, 12.5)
        {
        ...
        \foreach [
            ...
            evaluate=\b as \a using int(\b-1),
                ...
                \coordinate [below=0.5em of u\b d0.south] (a\a);
                \draw (u\b d0) -- (a\a);
                \draw (a\a) -| (u\a d0);
                \draw (a\a) -| (u\b d1);
            }
